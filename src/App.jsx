...
const reduser = (state, { type, payload }) => {
  switch(type) {
    ...
    case ACTIONS.EVALUATE:
      ...
      if (state.operation == null || state.currentOperand == null || state.previousOperant == null) {
        return state;
      }
...
const evaluate = ({ currentOperand, previousOperant, operation}) => {
...
const App = () => {
  const [{ currentOperand, previousOperant, operation }, dispatch] = useReducer(reduser, {});
